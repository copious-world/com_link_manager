	...
	"connections" : {
    	"publication_instance" : {
			...
			"parameters" : {
				"target" : "database",
				"module" : "message-relay-service",
				"class_definition" : "MultiPathRelayClient",
				"create" : true,
				"share" : false,
				"conf" : {
			        "address" : "192.168.1.81",
    	...
    	"publisher" : {
			...
			"parameters" : {
				...
				"share" : false,
				"conf" : {
					"subscription_link" : "192.168.1.81:5571",
					"tls" : false
				}
			}
    	},
